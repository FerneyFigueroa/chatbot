...
class MessageHandler {
    ...
    async sendWelcomeMessage(to, messageId, senderInfo) {
        ...
        const welcomeMessage = `Hola ${name}, Bienvenido a UNIRED, Tus servicios de internet en línea. ¿En qué puedo ayudarte hoy?`;
    ...
    async handleAppointmentFlow(to, message) {
        ...
        switch (state.step) {
            case 'name':
                state.name =capitalizeFirstLetter(message);
                state.step = 'petName';
                response = `Gracias ${state.name}, Ahora, ¿Cuál es el nombre de tu Mascota?`
                break;
            case 'petName':
